    ...
    return `
        <div class="pinned-popup card mb-2" 
            ...
            <div class="modal-header card-header bg-light">
                <h6 class="modal-title mb-0">${popup.popup_title || 'Pinned Content'}</h6>
                <button type="button" class="btn btn-sm btn-danger remove-pinned-popup" data-popup-id="${popupId}">
...
function initializePinnedPopupHandlers() {
    ...
    $(document).off('click', '.remove-pinned-popup').on('click', '.remove-pinned-popup', function() {
...
function addTestPopup() {
    const testPopupHtml = `
        <div class="pinned-popup card mb-2" 
            ...
            <div class="card-header bg-light">
                <h6 class="mb-0">Test Section 1</h6>
                <button type="button" class="btn btn-sm btn-danger float-end remove-pinned-popup">
                    <i class="fas fa-times"></i>
                </button>
            </div>
            <div class="card-body">
    ...
    // Initialize remove handler for the new popup
    $('.nested-droppable .remove-pinned-popup').off('click').on('click', function() {
