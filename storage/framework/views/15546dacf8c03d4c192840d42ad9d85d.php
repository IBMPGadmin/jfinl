...
<head>
  ...
  <style>
    ...
    .admin-avatar {
      background: linear-gradient(135deg, #4680ff 0%, #2d5aa0 100%) !important;
    ...
    .b-brand:hover {
      ...
      box-shadow: 0 2px 12px rgba(70, 128, 255, 0.15);
    }
...
<header class="pc-header">
  <div class="header-wrapper">
    <div class="me-auto pc-mob-drp">
      ...
      <ul class="list-unstyled">
        <li class="pc-h-item">
          <div class="admin-profile-section bg-light border rounded-pill px-3 py-2 d-flex align-items-center shadow-sm" style="margin: 8px 0;">
            <div class="admin-avatar bg-primary text-white rounded-circle d-flex align-items-center justify-content-center me-3" style="width: 40px; height: 40px;">
